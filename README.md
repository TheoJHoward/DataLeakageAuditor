...
pedantry, and each of the three has already caught something: `671 passed` and
`807 passed` are both true of this tree at this commit under two different
...
| `py -3.12 -m pytest tests` | 812 collected — **807 passed, 1 failed, 4 skipped** |
