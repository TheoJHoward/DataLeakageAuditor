...
pedantry, and each of the three has already caught something: `738 passed` and
`874 passed` are both true of this tree at this commit under two different
...
| `py -3.12 -m pytest tests` | 879 collected — **874 passed, 1 failed, 4 skipped** |
