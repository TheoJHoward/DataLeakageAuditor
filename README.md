...
pedantry, and each of the three has already caught something: `656 passed` and
`792 passed` are both true of this tree at this commit under two different
...
| `py -3.12 -m pytest tests` | 797 collected — **792 passed, 1 failed, 4 skipped** |
