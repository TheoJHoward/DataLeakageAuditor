...
pedantry, and each of the three has already caught something: `706 passed` and
`842 passed` are both true of this tree at this commit under two different
...
| `py -3.12 -m pytest tests` | 847 collected — **842 passed, 1 failed, 4 skipped** |
