...
for it is vocabulary. **Flag — see §3 below:** `PREREG.md` SC-11(g) as applied carries this
practice's substance; the scrub cites SC-11(g) and points here.
...
| P-47 | SC-11(g), on the vocabulary an excluded unit carries in a report. | Treat as a citation of SC-11(g); the entry here becomes redundant. |
